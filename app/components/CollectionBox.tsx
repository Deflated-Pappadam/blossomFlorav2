...
function CollectionsBox(props: CollectionProps) {
  return (
    <div>
      <div className="group relative flex h-[150px]  w-[150px]  overflow-hidden rounded-md md:h-[300px] md:min-h-[300px]  md:w-[300px]">
        <Image
          width={1080}
          height={1080}
          src={props.url}
          alt=""
          className="hover: blu absolute top-0 h-full  w-full  object-cover transition-all delay-100 duration-1000 group-hover:scale-[105%] group-hover:blur-[4px]"
        />
